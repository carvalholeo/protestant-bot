...
class BlocklistController {
  async block(request: Request, response: Response) {
    ...
    try {
      ...
      logger.info(
        `${message} in BlocklistController.block.try. ID ${uniqueIdentifier}`
      );
      ...
      logger.error(
        `${error} in BlocklistController.block.catch. ID ${uniqueIdentifier}`
      );
  ...
  async unblock(request: Request, response: Response) {
    ...
    try {
      ...
      logger.info(
        `${message} in BlocklistController.unblock.try. ID ${uniqueIdentifier}`
      );
      ...
      logger.error(
        `${error} in BlocklistController.unblock.catch. ID ${uniqueIdentifier}`
      );
