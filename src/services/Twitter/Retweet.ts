...
import { ErrorLog, AccessLog, RetweetLog, TweetQueue, Blocklist } from '../../models';
...
class Retweet {
   ...
   * @param tweet A single tweet to be retweeted
   */
   ...
   * @return Return true if is actually blocked.
   */
